...
Page({
  ...
  getInputValue:function(e){
    if(e.currentTarget.id=="clCph_inp"){
      let clCph=e.detail.value;
      shjlListPage.setData({clCph:clCph});
    }
  ...
  resetToolBarData:function(){
    shjlListPage.setData({clCph:"",shrYhm:"",shksrq:"",shkssj:"",shjsrq:"",shjssj:""});
  },
  ...
  getListData:function(){
    ...
    var clCph=shjlListPage.data.clCph;
    ...
    console.log("clCph==="+clCph)
    console.log("shrYhm==="+shrYhm)
    console.log("shsjks==="+shsjks)
    console.log("shsjjs==="+shsjjs)
    
    wx.request({
      url: rootIP+"getCLSHJLList",
      data:{page:currentPage,rows:pageSize,clCph:clCph,shrYhm:shrYhm,shsjks:shsjks,shsjjs:shsjjs},
      method: 'POST',
      header: {
        'content-type': 'application/x-www-form-urlencoded',
      },
    ...
    wx.showModal({
      ...
      success (res) {
        if (res.confirm) {
          ...
          wx.request({
            url: rootIP+"deleteCheLiangShenHeJiLu",
            data:{ids:id},
            method: 'POST',
            header: {
              'content-type': 'application/x-www-form-urlencoded',
